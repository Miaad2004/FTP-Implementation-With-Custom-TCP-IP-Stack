"""
FTP Client Command Handler Module

Implements command-line interface for FTP client operations including:
- Setting FTP options
- Executing system commands
- Handling SITE commands (e.g. CHMOD)
- Managing client connection lifecycle
"""
